...
function Epoch(name,mode,targetelement,multiselect) {
	...
	*/
	function calConfig() {
		...
		self.maxDate = new Date(2022,11,31);
	...
	*/
	function setLang() {
		self.daylist = new Array('Do','Lu','Ma','Me','Gi','Ve','Sa','Do','Lu','Ma','Me','Gi','Ve','Sa');
		self.months_sh = new Array('Gen','Feb','Mar','Apr','Mag','Giu','Lug','Ago','Set','Ott','Nov','Dic');
		self.monthup_title = 'Vai al mese successivo';
		self.monthdn_title = 'Vai al mese precedente';
		self.clearbtn_caption = 'Azzera';
		self.clearbtn_title = 'Azzera tutte le date selezionate sul calendario';
		self.maxrange_caption = 'Questo &egrave; l\'intervallo massimo';
		self.closebtn_caption = 'Chiuda';
		self.closebtn_title = 'Chiuda il calendario';
	}
	//-----------------------------------------------------------------------------
	/**
